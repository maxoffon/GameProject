...
public class QuizSet : MonoBehaviour
{
    ...
    private string[][] choices = new string[][]
    {
        ...
        new string[] { "A.   Это цифровой отпечаток ноги", "Б.   Это цифровая информация пользователя, которую нельзя удалить",
            "В.   Это информация о пользователе, хранящаяся на компьютере",
